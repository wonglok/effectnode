//https://unpkg.com/browse/rollup-plugin-node-resolve@2.1.1/dist/rollup-plugin-node-resolve.es6.js
                                        ...
                                        reject(
                                            Error(
                                                'Package ' +
                                                    ...
                                                    ' (imported by ' +
                                                    importer +
                                                    ") does not have a jsnext:main field. You should either allow legacy modules with options.main, or skip it with options.skip = ['" +
                                                    importee +
                                                    "'])",
                                            ),
                                        )
                                    ...
                                    reject(
                                        Error(
                                            'To import from a package in node_modules (' +
                                                importee +
                                                '), either options.jsnext or options.main must be true',
                                        ),
                                    )
                            }
                            return pkg
